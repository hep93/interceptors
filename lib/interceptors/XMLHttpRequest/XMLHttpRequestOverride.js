...
var createXMLHttpRequestOverride = function (options) {
    ...
    return _a = /** @class */ (function () {
                ...
                Promise.resolve(until_1.until(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    ...
                    if (mockedResponse) {
                        ...
                        if (mockedResponse.body === null || mockedResponse.body === undefined || typeof mockedResponse.body === 'string') {
                            ...
                            var arrayBuffer = mockedResponse.body;
                            _this.responseText = (new Uint8Array(arrayBuffer)).toString();
                            _this.response = arrayBuffer;
                        }
                        ...
                        if (mockedResponse.body && _this.response) {
                            ...
                            var bodyArray = new Uint8Array(bufferFrom_1.bufferFrom(mockedResponse.body));
                        ...
                        if (_this.responseType === 'arraybuffer') {
                            originalRequest_1.responseType = _this.responseType;
                        }
             ...
             */
            XMLHttpRequestOverride.prototype.getResponseBody = function (_body) {
                // Handle an improperly set "null" value of the mocked response body.
                var body = _body !== null && _body !== void 0 ? _body : '';
                debug('coerced response body to', body);
                switch (this.responseType) {
                    case 'json': {
                        debug('resolving response body as JSON');
                        return parseJson_1.parseJson(body.toString());
                    }
                    case 'blob': {
                    ...
                    case 'arraybuffer': {
                        ...
                        if ((typeof body) === 'string') {
                            var arrayBuffer = bufferFrom_1.bufferFrom(body);
                            return arrayBuffer;
                        }
                        return body;
                    }
